      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-4 px-4 py-4 md:grid-cols-[1fr_220px] md:px-6">
        <main className="max-h-[calc(100vh-100px)] overflow-y-auto rounded-2xl border border-stone-200 bg-white p-5 md:p-8">
          ...
          <div className="mt-6 space-y-3">
            ...
            <article className="rounded-xl border border-stone-200 bg-white p-4">
              <p className="text-xs font-semibold text-stone-600">오답 노트</p>
              <textarea
                value={note}
                onChange={(e) => setNote(e.target.value)}
                placeholder="틀린 이유나 기억해야 할 점을 기록하세요 (페이지 이동 시 자동 저장)"
                className="mt-2 min-h-[100px] w-full resize-none rounded-lg border border-stone-200 bg-stone-50 p-3 text-sm text-stone-800 outline-none ring-red-200 transition focus:ring-2"
              />
            </article>
          </div>
