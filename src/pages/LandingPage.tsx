        ...
        <section className="landing-hero relative">
          ...
          <div className="landing-container relative grid items-center gap-14 py-20 lg:grid-cols-[0.94fr_1.06fr] lg:py-24">
            <div className="landing-fade-up">
              ...
              <div className="mt-9 grid w-full grid-cols-2 gap-3 sm:w-fit">
                <Link to="/home" className="landing-primary-cta col-start-1 !gap-2 !px-3 text-sm sm:!px-5 sm:text-base">
                  문제 풀이 시작하기 <span className="landing-arrow" aria-hidden="true">→</span>
                </Link>
                <a href="#how-it-works" className="landing-secondary-cta col-start-1 row-start-2 !gap-2 !px-3 text-sm sm:!px-5 sm:text-base">
                  사용법 먼저 보기 <span aria-hidden="true">↓</span>
                </a>
                <Link to="/apps" className="landing-secondary-cta col-start-2 row-start-2 !gap-2 !px-3 text-sm sm:!px-5 sm:text-base">
