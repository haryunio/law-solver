  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        clauses: [
          { text: "오프라인 데이터는 기본적으로 이용자 기기의 브라우저 localStorage에만 저장되며 자동으로 운영자 서버에 전송·동기화되지 않습니다. Premium 회원이 클라우드 백업을 직접 실행한 경우에만 암호화된 사본이 전송됩니다." },
          {
    ...
    articles: [
      {
        ...
        clauses: [
          ...
          { text: "개인정보에 관한 내용이 이 약관과 개인정보처리방침에서 다르면 정보주체에게 유리한 내용과 관계 법령을 우선 적용합니다." },
          {
            ...
            items: [
              { text: "오프라인 기능: 학습 데이터는 기본적으로 브라우저 localStorage에 저장되며 자동 전송되지 않습니다. 이용자가 Premium 클라우드 백업을 실행하면 암호화된 사본만 서버에 저장됩니다." },
